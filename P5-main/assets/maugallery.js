(function($) {
  ...
  $.fn.mauGallery.methods = {
    ...
    prevImage(lightboxId) {
      ...
      if (activeTag === "all") {
        imagesCollection = $(".gallery-item").toArray();
      } else {
        imagesCollection = $(".gallery-item[data-gallery-tag='" + activeTag + "']").toArray();
      }
      ...
      let index = imagesCollection.indexOf(activeImage.closest(".gallery-item")[0]);
      let prevIndex = (index === 0) ? imagesCollection.length - 1 : index - 1;

      $(".lightboxImage").attr("src", $(imagesCollection[prevIndex]).find("img").attr("src"));
    },
    ...
    nextImage(lightboxId) {
      ...
      $(".lightboxImage").attr("src", $(imagesCollection[nextIndex]).find("img").attr("src"));
    },
